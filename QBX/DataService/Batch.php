...
use QBX\Data\IntuitRestServiceDef\IPPBatchItemRequest;
use QBX\Data\IntuitRestServiceDef\IPPBatchItemResponse;
use QBX\Data\IntuitRestServiceDef\IPPIntuitBatchRequest;
use QBX\Data\IntuitRestServiceDef\IPPQueryResponse;
use QBX\DataService\IntuitBatchResponse;
use QBX\DataService\IntuitResponseStatus;
use QBX\Utility\Serialization\XmlObjectSerializer;
use QBX\Exception\IdsExceptionManager;
use QBX\Exception\IdsError;
...
class Batch
{
    ...
    public function Execute()
    {
        ...
        try {
            ...
            while (1) {
                ...
                if (is_null($matchingElementArray)) break;
    ...
    private function ProcessBatchItemResponse($oneXmlObj)
    {
        ...
        if (NULL == $oneXmlObj) return $result;
