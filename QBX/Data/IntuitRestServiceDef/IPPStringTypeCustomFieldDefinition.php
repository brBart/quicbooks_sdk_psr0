 ...
 */
class IPPStringTypeCustomFieldDefinitionWrapper extends IPPStringTypeCustomFieldDefinition
{
    ...
    public function __construct($keyValInitializers = array(), $verbose = FALSE)
    {
        foreach ($keyValInitializers as $initPropName => $initPropVal) {
            if (property_exists('IPPStringTypeCustomFieldDefinitionWrapper', $initPropName)) {
