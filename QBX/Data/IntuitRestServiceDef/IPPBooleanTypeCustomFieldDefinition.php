 ...
 */
class IPPBooleanTypeCustomFieldDefinitionWrapper extends IPPBooleanTypeCustomFieldDefinition
{
    ...
    public function __construct($keyValInitializers = array(), $verbose = FALSE)
    {
        foreach ($keyValInitializers as $initPropName => $initPropVal) {
            if (property_exists('IPPBooleanTypeCustomFieldDefinitionWrapper', $initPropName)) {
